...
public class Tag {
    ...
    private void print(Tag t, int indent) {
        ...
        if (type == Type.TAG_Byte_Array) {
            ...
            System.out.println("[");
            indent(indent*2);
            System.out.print(ByteToHex.bytesToHex(new byte[]{b[0]}));
            for (int i = 1; i < b.length; i++) {
                System.out.print(new StringBuilder().append(", ").append(ByteToHex.bytesToHex(new byte[]{b[i]})).toString());
            }
            System.out.println();
            indent(indent);
            System.out.println("]");
            ...
            System.out.println(": (" + i.length * 4 + " bytes, " + i.length + " numbers)");
            ...
            for (int j = 1; j < i.length; j++) {
                System.out.print(new StringBuilder().append(", ").append(i[j]).toString());
            }
            System.out.println();
            indent(indent);
            System.out.println("]");
